...
return [
    'routes' => [
        ...
        ['name' => 'signature_admin#uploadAssets', 'url' => '/api/signature-admin/assets', 'verb' => 'POST'],
        ['name' => 'signature_admin#deleteAsset', 'url' => '/api/signature-admin/assets/{slug}', 'verb' => 'DELETE'],
        ['name' => 'signature_admin#assetBytes', 'url' => '/api/signature-admin/assets/{slug}/bytes', 'verb' => 'GET'],

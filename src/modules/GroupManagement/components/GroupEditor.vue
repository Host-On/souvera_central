    ...
    <div class="editor-content">
      <form @submit.prevent="saveGroup" class="group-form">
        ...
        <div class="form-group">
          ...
          <p v-else class="help-text">{{ t('souvera_central', 'Eindeutige Gruppen-ID, kann später nicht geändert werden. Nur Buchstaben, Zahlen, _ und - erlaubt.') }}</p>
        </div>
        ...
        <div class="form-group">
          ...
          <p v-else class="help-text">{{ t('souvera_central', 'Freundlicher Name der Gruppe, wie er in der Benutzeroberfläche angezeigt wird') }}</p>
        </div>
        ...
        <div v-if="isProtected" class="info-box warning">
          ...
          <div class="info-content">
            ...
            <p>{{ t('souvera_central', 'Diese Gruppe ist eine Systemgruppe und kann nicht gelöscht werden.') }}</p>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    async loadGroupMembers() {
      try {
        const url = generateUrl('/apps/souvera_central/api/groups/manage/{id}/members', { id: this.formData.groupId })
    ...
    async saveGroup() {
      ...
      try {
        if (this.isEditMode) {
          ...
          const url = generateUrl('/apps/souvera_central/api/groups/manage/{id}', { id: this.formData.groupId })
    ...
    async updateGroupMembers() {
      ...
      for (const userId of membersToAdd) {
        try {
          const addUrl = generateUrl('/apps/souvera_central/api/groups/manage/{id}/members', { id: this.formData.groupId })

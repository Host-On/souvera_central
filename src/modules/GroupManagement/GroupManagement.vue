              ...
              <tr v-for="group in groups" :key="group.id" class="group-row" @click="selectGroup(group)">
                <td class="group-column">
                  <div class="group-info">
                    ...
                    <span v-if="group.isProtected" class="protected-badge" :title="t('souvera_central', 'Systemgruppe')">
                ...
                <td class="actions-column">
                  <div class="group-actions">
                    <button class="icon-rename" :title="t('souvera_central', 'Bearbeiten')" @click.stop="editGroup(group)"></button>
                    <button
                      class="icon-delete"
                      :title="group.isProtected ? t('souvera_central', 'Systemgruppe kann nicht gelöscht werden') : t('souvera_central', 'Löschen')"
...
export default {
  ...
  methods: {
    ...
    async deleteGroup(group) {
      ...
      if (!confirm(this.t('souvera_central', 'Möchten Sie die Gruppe "{group}" wirklich löschen?', { group: group.displayName }))) {
        return
      }

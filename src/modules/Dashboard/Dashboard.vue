<template>
  <div class="dashboard-container">
    ...
    <div v-if="isLicenseLimitReached" class="critical-warning">
      <div class="warning-content">
        ...
        <div class="warning-text">
          ...
          <p>{{ t('souvera_central', 'Sie haben {count} von {total} Lizenzen genutzt. Es können keine weiteren Benutzer erstellt werden.', { count: userCount, total: licenseTotal }) }}</p>
        </div>
    ...
    <div v-else-if="isLicenseWarning" class="warning-banner">
      <div class="warning-content">
        ...
        <div class="warning-text">
          ...
          <p>{{ t('souvera_central', 'Sie haben {count} von {total} Lizenzen genutzt ({percentage}%). Erweitern Sie rechtzeitig Ihre Lizenzen.', { count: userCount, total: licenseTotal, percentage: licensePercentage }) }}</p>
        </div>
    ...
    <div class="stats-grid">
      ...
      <!-- Lizenzen -->
      <div class="stat-card" :class="{ 'stat-warning': isLicenseWarning, 'stat-critical': isLicenseLimitReached }">

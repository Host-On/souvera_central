                ...
                <div class="record-grid">
                    <div class="record-line">
                        ...
                        <div class="copy-field">
                            ...
                            <button class="copy-btn" data-testid="bimi-copy-host" @click="copyText(payload.host, 'host')">{{ copied === 'host' ? '✓' : t('souvera_central', 'Kopieren') }}</button>
                        </div>
                    </div>
                    <div class="record-line">
                ...
                <div class="public-urls">
                    <div class="record-line">
                        ...
                        <div class="copy-field">
                            ...
                            <button class="copy-btn" @click="copyText(payload.logoUrl, 'logo')">{{ copied === 'logo' ? '✓' : t('souvera_central', 'Kopieren') }}</button>
                        </div>
                    </div>
                    <div class="record-line highlight-api">
                        ...
                        <div class="copy-field">
                            ...
                            <button class="copy-btn" data-testid="bimi-copy-api" @click="copyText(publicApiUrl, 'api')">{{ copied === 'api' ? '✓' : t('souvera_central', 'Kopieren') }}</button>
                        </div>
